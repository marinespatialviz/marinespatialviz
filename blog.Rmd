...
6, Add to Leaflet map as GeoJson (example below is for hosting [it](https://marinespatialviz.github.io/marinespatialviz/leaflet.html#external_geojson) externally, with image icon and tooltip)

<script async src="https://jsfiddle.net/WandaBodnar/3shwwtsa/embed/js,html,css,result/dark/"></script>
