...
For this example, four geotagged images used that are available on Flickr to download. In order to run this code, the software Strawberry Perl might have to be installed as well.
