...
Let's look into how you can use leaflet.js on [JSFiddle](https://jsfiddle.net/) which is an online code editor used to test your JavaScript, CSS, HTML.
$~$
...
The first step here is the add leaflet.js and leaflet.css as an external resource.
...
**In the examples below both text editor and jsFiddle codes will be displayed.**
