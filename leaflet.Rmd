...
Let's look into how you can use leaflet.js on [JSFiddle](https://jsfiddle.net/) which is an online code editor used to test your JavaScript, CSS, HTML; and in [Atom](https://atom.io/) that you can download and use as text and source code editor.
